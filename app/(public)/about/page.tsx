...
import AboutDashboard from "@/components/public/AboutDashboard";
...
export default function AboutPage() {
  return (
    <main className="overflow-x-hidden">
      ...
      <div className="page-enter px-4 md:px-10 pb-8 pt-8">
        {/* Header */}
        <div className="mb-8">
          <p className="text-xs font-semibold text-ec-teal uppercase tracking-widest mb-2">About EverCool Thailand</p>
          <h2 className="text-2xl md:text-3xl font-black text-ec-text leading-tight mb-3">
